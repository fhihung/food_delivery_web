    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{ asset('back/images/2.png') }}">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Nhà phân phối thực phẩm</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{ URL::to('/add-brand-product') }}">Thêm nhà phân phối</a></li>
                        <li><a href="{{ URL::to('/all-brand-product') }}">Liệt kê nhà phân phối</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
...
<section id="main-content">
    ...
    <div class="footer">
        <div class="wthree-copyright">
            <p>© 2023 All rights reserved | Design by <a href="#">Company Name</a></p>
        </div>
    </div>
    <!-- / footer -->
</section>
